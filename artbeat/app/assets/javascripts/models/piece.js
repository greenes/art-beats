var Piece = function(id, gallery_id, piece_name, piece_date, piece_description){
  this.id = id;
...
Piece.prototype = {
  ...
  save: function(){
    $.ajax({
      type: 'POST',
      data: { piece: {gallery_id: this.gallery, piece_name: this.piece_name, piece_date: this.date, piece_description: this.piece_description}},
      dataType: 'json',
      url: 'http://localhost:3000/artists/' + this.artist + '/galleries/' + this.gallery + '/pieces'
